...
<br><br><br>
  <form class="form-group" action="index.php?menu=report-donate-month" method="post">
    <div class="box-body">
      <div class="col-md-12">
      เดือน
      </div>
  ...
  <form class="form-group" action="index.php?menu=report-donate-year" method="post" enctype="multipart/form-data">
    <div class="box-body">
      <div class="col-md-12">
      ปี
      </div>
