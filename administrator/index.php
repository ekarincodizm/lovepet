...
<script type="text/javascript">
        function openUrl(id,value){
            window.location="index.php?menu=find-home-update-status&id="+id+"&value="+value;
        }
        function openUrld(id,value){
            window.location="index.php?menu=donate-update-status&id="+id+"&value="+value;
        }
        function openUrlOrder(id,value){
            window.location="index.php?menu=order-update-status&id="+id+"&value="+value;
        }
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">Your Web Site</a>.</strong> All rights
    reserved.
  </footer>
